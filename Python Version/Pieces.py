...
class Piece:
	...
	def __init__(self, col, sym, alt=u'\u2656'):
		...
		self.symbol = sym
		self.altsymbol = alt
	def displayAsText(self, alt=False,plain=False):
		if plain:
			if self.colour:
				print(self.symbol,end='')
			else:
				print(self.symbol.upper(),end='')
		elif alt:
			print(bcolours.PIECECOLOURALT[self.colour] + self.symbol + bcolours.ENDC,end='')
		else:
			print(bcolours.PIECECOLOUR[self.colour] + self.symbol + bcolours.ENDC,end='')
	def displayAsUnicode(self, squarecolour=0, alt=False):
		if alt:
			print(bcolours.PIECECOLOURALT[self.colour] + bcolours.BGCOLOURALT[squarecolour] + self.altsymbol + " " + bcolours.ENDC,end='')
		else:
			print(bcolours.PIECECOLOUR[self.colour] + bcolours.BGCOLOUR[squarecolour] + self.altsymbol + " " + bcolours.ENDC,end='')
